...
async function startOneUser(): Promise<void> {
    ...
    const onConnect = await connectionManager.connectToRoomSocket(process.env.ROOM_ID ? process.env.ROOM_ID : '_/global/maps.jeffreyvandevelde.be/fantasy/map.json', 'TEST', ['male3'],
        {
            x: 783,
            y: 170
        }, {
